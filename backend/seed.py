...
def seed():
    ...
    try:
        ...
        budget_data = [
            ("Aplaya",          2025, 2_150_000),
            ("Balibago",        2025, 2_780_000),
            ("Caingin",         2025, 1_920_000),
            ("Dila",            2025, 2_040_000),
            ("Dita",            2025, 2_310_000),
            ("Don Jose",        2025, 2_890_000),
            ("Ibaba",           2025, 1_840_000),
            ("Kanluran",        2025, 2_120_000),
            ("Labas",           2025, 2_450_000),
            ("Macabling",       2025, 2_680_000),
            ("Malitlit",        2025, 1_990_000),
            ("Malusak",         2025, 1_760_000),
            ("Market Area",     2025, 2_540_000),
            ("Pooc",            2025, 2_220_000),
            ("Pulong Santa Cruz",2025,2_380_000),
            ("Santo Domingo",   2025, 2_610_000),
            ("Sinalhan",        2025, 2_090_000),
            ("Tagapo",          2025, 2_760_000),
            # 2024 historical data for Balibago and Don Jose
            ("Balibago",        2024, 2_550_000),
            ("Don Jose",        2024, 2_710_000),
        ]
