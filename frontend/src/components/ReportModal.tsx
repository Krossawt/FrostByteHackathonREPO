                  ...
                  <>
                    ...
                    <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr 1fr', gap: '12px', marginBottom: '22px' }}>
                      {[
                        ...
                        <div key={item.label} style={{ border: '1px solid #e5e0da', borderRadius: '8px', padding: '14px 14px' }}>
                          <div style={{ fontSize: '9.5px', color: '#888', textTransform: 'uppercase', letterSpacing: '0.06em', fontWeight: 700 }}>{item.label}</div>
                          <div style={{ fontFamily: 'var(--font-display)', fontWeight: 900, fontSize: '18px', color: item.color, marginTop: '4px' }}>{item.val}</div>
                        </div>
                      ))}
                    </div>
