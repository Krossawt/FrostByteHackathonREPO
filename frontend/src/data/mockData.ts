...
export const barangaySummary = [
  { barangay: 'Aplaya',           annualBudget: 0, spent: 0, projects: 6,  remaining: 0 },
  { barangay: 'Balibago',         annualBudget: 0, spent: 0, projects: 9,  remaining: 0 },
  { barangay: 'Caingin',          annualBudget: 0, spent: 0, projects: 5,  remaining: 0 },
  { barangay: 'Dila',             annualBudget: 0, spent: 0, projects: 7,  remaining: 0 },
  { barangay: 'Dita',             annualBudget: 0, spent: 0, projects: 8,  remaining: 0 },
  { barangay: 'Don Jose',         annualBudget: 0, spent: 0, projects: 11, remaining: 0 },
  { barangay: 'Ibaba',            annualBudget: 0, spent: 0, projects: 5,  remaining: 0 },
  { barangay: 'Kanluran',         annualBudget: 0, spent: 0, projects: 7,  remaining: 0 },
  { barangay: 'Labas',            annualBudget: 0, spent: 0, projects: 8,  remaining: 0 },
  { barangay: 'Macabling',        annualBudget: 0, spent: 0, projects: 10, remaining: 0 },
  { barangay: 'Malitlit',         annualBudget: 0, spent: 0, projects: 5,  remaining: 0 },
  { barangay: 'Malusak',          annualBudget: 0, spent: 0, projects: 4,  remaining: 0 },
  { barangay: 'Market Area',      annualBudget: 0, spent: 0, projects: 9,  remaining: 0 },
  { barangay: 'Pooc',             annualBudget: 0, spent: 0, projects: 7,  remaining: 0 },
  { barangay: 'Pulong Santa Cruz',annualBudget: 0, spent: 0, projects: 8,  remaining: 0 },
  { barangay: 'Santo Domingo',    annualBudget: 0, spent: 0, projects: 10, remaining: 0 },
  { barangay: 'Sinalhan',         annualBudget: 0, spent: 0, projects: 6,  remaining: 0 },
  { barangay: 'Tagapo',           annualBudget: 0, spent: 0, projects: 11, remaining: 0 },
]

export const cityHighlights = [
  { label: 'Total Barangays',      value: '18'  },
  { label: 'Active SK Projects',   value: '141' },
  { label: 'Funds Released',       value: '₱0' },
